...
/**
 * Class ExtensionSetupActiveTaskTest
 *
 * @author Benjamin Kluge <b.kluge@neusta.de>
 * @package TeamNeusta\Magallanes\Tests\Task\TYPO3\Console
 */
class ExtensionSetupActiveTaskTest extends TestCase
{

    /**
     * consoleExtensionSetupActiveFlagsDataProvider
     *
     * @return array
     */
    public function consoleExtensionSetupActiveFlagsDataProvider(): array
    {
        return [
            'extension setupActive' => [
                'yaml' => 'consoleExtensionSetupActive.yml',
                'expected' => [
                    ...
                    'ssh -p 22 -q -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no tester@testhost "cd /var/www/test && vendor/bin/typo3cms extension:setupactive"'
                ]
            ]
        ];
    }
    ...
    /**
     * testConsoleExtensionSetupActiveFlags
     *
     * @dataProvider consoleExtensionSetupActiveFlagsDataProvider
     * @test
     * @param string $ymlFile
     * @param array $expectedCommands
     * @return void
     */
    public function testConsoleExtensionSetupActiveFlags($ymlFile, array $expectedCommands)
    {
